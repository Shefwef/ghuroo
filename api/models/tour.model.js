...
export const validateTour = (tourData) => {
  ...
  if (
    ...
    typeof tourData.duration_days !== "number" ||
    tourData.duration_days <= 0
  ) {
  ...
  if (
    ...
    typeof tourData.thumbnail_url !== "string" ||
    tourData.thumbnail_url.trim() === ""
  ) {
  ...
  if (
    !tourData.created_by ||
    typeof tourData.created_by !== "string" ||
    tourData.created_by.trim() === ""
  ) {
  ...
  if (
    tourData.is_featured !== undefined &&
    typeof tourData.is_featured !== "boolean"
  ) {
...
export class Tour {
  constructor(tourData) {
    ...
    this.is_featured =
      tourData.is_featured !== undefined
        ? tourData.is_featured
        : TOUR_DEFAULTS.is_featured;
